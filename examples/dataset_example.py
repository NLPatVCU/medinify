...
dataset1 = Dataset()  # use can specify scraper type and/or whether or not to collect urls and user ids
...
dataset2.load_file('./data/citalopram.csv')  # file name must exist on your system
